...
public class RegisterPageThreeActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register_page_three);
        Intent i = getIntent();
        ...
        year.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> arg0, View arg1,
                                       int arg2, long arg3) {
                lister = new CarAsyncTask(manufacture, RegisterPageThreeActivity.this);
                ...
                manufacture.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                    ...
                    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                        lister = new CarAsyncTask(model, RegisterPageThreeActivity.this);
                        ...
                        model.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                            ...
                            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                                ...
                                vid = new VehicleIdAsyncTask(model_type, RegisterPageThreeActivity.this);
                                String s = manufacture.getSelectedItem().toString();
                                String d[] = new String[10];
                                if(s.contains(" "))
                                {
